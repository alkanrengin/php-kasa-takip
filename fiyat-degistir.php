...
<div class="container" >
    <h1 class="text-center mt-5">Fiyat Değiştir</h1>
        ...
        while ($sonuc = $urunsor->fetch(PDO::FETCH_ASSOC)) {
            ...
            if(intval($adet)<=2){
                ...
                <tr style="--bs-table-bg:red; --bs-table-color:white;text-align: center">
                    ...
                    <td><form method="post" action="indirim-yap.php"><button name="zam" class="btn btn-primary" value="<?php  echo $sonuc["kod"];?>">İndirim Yap</button></form></td>
