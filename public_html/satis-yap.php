...
<div class="container" >
    <h1 class="text-center mt-5">Ürün Seç</h1>
            ...
            while ($sonuc = $urunsor->fetch(PDO::FETCH_ASSOC)) {
                ...
                if(intval($adet)<1){
                    ...
                    <tr style="--bs-table-bg:red; --bs-table-color:white;text-align: center">
                        ...
                        <td><form method="post" action="satis_yap_devam.php"><button name="satis" disabled class="btn btn-primary" value="<?php  echo $sonuc["kod"];?>">Satış Yap</button></form></td>
                    </tr>
                <?php }
                else{ ?>
                    <tr style="text-align: center">
                        ...
                        <td><?php echo $sonuc["fiyat"];?></td>
                        <td><?php echo $sonuc["kategori"];?></td>
                        <td><form method="post" action="satis_yap_devam.php"><button name="satis"  class="btn btn-primary" value="<?php  echo $sonuc["kod"];?>">Satış Yap</button></form></td>
